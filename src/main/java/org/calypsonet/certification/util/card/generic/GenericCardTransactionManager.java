...
public interface GenericCardTransactionManager {
   ...
   * @since 2.0.0
   */
  GenericCardTransactionManager prepareApdu(String apduCommand);
   ...
   * @since 2.0.0
   */
  GenericCardTransactionManager prepareApdu(byte[] apduCommand);
   ...
   * @since 2.0.0
   */
  GenericCardTransactionManager prepareApdu(byte cla, byte ins, byte p1, byte p2, byte[] dataIn, Byte le);
